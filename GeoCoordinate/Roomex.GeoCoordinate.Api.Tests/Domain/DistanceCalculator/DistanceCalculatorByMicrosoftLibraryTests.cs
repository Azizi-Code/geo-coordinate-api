...
public class DistanceCalculatorByMicrosoftLibraryTests_Calculate
{
    [Fact]
    public void ValidCoordinates_ReturnsDistance()
    {
        ...
        var distanceCalculator = DistanceCalculatorFactory.GetInstance(CalculatorType.MicrosoftLibrary);
